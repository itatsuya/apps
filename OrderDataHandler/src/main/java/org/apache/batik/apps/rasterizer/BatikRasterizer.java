 ...
 */
public class BatikRasterizer implements SVGConverterController {
    /**
    ...
    /**
     * SVG image filter implementation to use in the conversion.
     */
    protected SVGImageFilter imageFilter = null;

    /**
     * Sets the SVG image filter to use.
     */
    ...
    /**
     * Whethet to ignore color profile on images in the conversion.
     */
    ...
    public BatikRasterizer(String[] args){
    ...
    public void execute() throws SVGConverterException{
        ...
        c.setSecurityOff(true);
        c.setSVGImageFilter(imageFilter);
        c.setIgnoreColorProfile(ignoreColorProfile);
        List sources = new ArrayList();

        int nArgs = args.size();
        for (int i=0; i<nArgs; i++){
            //System.out.println("arg " + (String)args.get(i));
        ...
        try {
        	//System.out.println("before converter execute");
            c.execute();
        	//System.out.println("after converter execute");
...
/*    public static void main(String [] args) {
        (new BatikRasterizer(args)).execute();
        System.exit(0);
    }*/
