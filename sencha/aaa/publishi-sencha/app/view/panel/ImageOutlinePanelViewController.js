 ...
 i < length; i++) {
    ...
    onExtractOutlineCheckboxChange: function(field, newValue, oldValue, eOpts) {
        ...
        if (newValue) {
            ...
            imageObject.imageAdjustFilter.background = 255
 // Blend against white when extracting outline
            imageObject.applyFilters()
            ...
            imageObject.imageAdjustFilter.background = 0
 // Blend against black otherwise
            imageObject.applyFilters()
