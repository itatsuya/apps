/*
 * File: app/view/ProductDesignerImageUploadViewModel.js
 *
...
Ext.define('RolandKioskPrint.view.ProductDesignerImageUploadViewModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel.productdesignerimageupload',
    ...
    formulas: {
        labelString: function(get) {
            ...
            if (screenType == 'uploadMethodSelection') {
                var backgroundImage = get('backgroundImage')

                if (backgroundImage) {
                    return RolandKioskPrint.app.getString('label.designer.selectMethodToTakePictureTitle')
                ...
                return RolandKioskPrint.app.getString('label.designer.takePictureOfProductTitle')

            } else if (screenType == 'imageUploadSteps') {
                return RolandKioskPrint.app.getString('label.designer.uploadImageTitle')
        ...
        nextCloseBtnText: function(get) {
            ...
            if (screenType == 'networkSettingsQRCode' || screenType == 'imageShootingTips' ||
            screenType == 'imageUploadSteps') {
        ...
        closeBackBtnText: function(get) {
            ...
            } else if (screenType == 'networkSettingsQRCode' || screenType == 'imageShootingTips' ||
            screenType == 'imageUploadSteps') {
